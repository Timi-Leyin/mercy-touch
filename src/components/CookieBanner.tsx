    ...
    <div className="fixed flex bg-black z-[20] justify-end items-end bg-opacity-60 backdrop-blur-md top-0 left-0 w-screen h-screen">
      <div className="bg-white p-7 rounded-md shadow h-max my-5 mx-10">
        ...
        <p className="my-3">
          ...
          vitae officiis iste magnam ipsam doloribus enim eos quas corrupti
          eaque praesentium molestiae quis odit assumenda hic quam architecto
          sapiente excepturi perspiciatis, facilis ullam explicabo saepe!
          Mollitia veritatis ut illum eligendi harum dolorum asperiores veniam,
          nemo sapiente. Excepturi, deserunt enim.
        </p>
